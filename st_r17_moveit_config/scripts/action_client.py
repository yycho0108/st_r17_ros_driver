#!/usr/bin/python
#st_r17_controller/follow_joint_trajectory
...
class STR17Client:
    def __init__(self):
        ...
        self.jta = actionlib.SimpleActionClient('/st_r17/st_r17_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
